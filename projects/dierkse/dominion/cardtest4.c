...
int main(){
    ...
    memcpy(G.deck[2], copper, sizeof(int) * 20); // set all the cards in deck to copper
    memcpy(G.discard[2], copper, sizeof(int) * 11); // set all the cards in discard to copper
    ...
    int highscore = scoreFor(winningPlayers[0], &G);
